...
//滚动图
	...
	function picRoll(config){
		...
		var imgWidth = $imgUl.find('img').width()||280;
...
$(function(){
	$(".weather_select_city").hover(function(){
		$(this).find("ul").show();
		$("#ascrail2001").show();
	},function(){
		$(this).find("ul").hide();
	...
	$(".weather_select_a").hover(function(){
		$(this).find("ul").show();
	...
	$(".weather_select_jq").hover(function(){
		$(this).find("ul").show();
		$("#ascrail2002").show();
	},function(){
		$(this).find("ul").hide();
	...
	$(".weather_hot .weather_rd h1 span a").hover(function(){
		var hot = $(".weather_hot .weather_rd h1 span a").index(this);
		$(".weather_hot .weather_rd ul").hide();
		$(".weather_hot .weather_rd ul").eq(hot).show();
		$(".weather_hot .weather_rd h1 span a").removeClass("m");
		$(this).addClass("m");
	})
	$("#scroll").pislider({
		child:"child",
	...
	//大事件
	$('.weather_case li').mousemove(function(){
		$(this).addClass('on').siblings('li').removeClass('on');
	})
	$('.weather_shzs ul li').mousemove(function(){
		$(this).addClass('m').siblings('li').removeClass('m');
	})
	
	$(".weather_case ul li:even").addClass("ons");
	//周边
	$(".around h1 span").click(function(){
		var around = $(".around h1 span").index(this);
		$(".around ul").hide();
		$(".around ul").eq(around).show();	
		$(".around h1 span").removeClass("m");
		$(this).addClass("m");
	})
	
	$('.weather_lo_box,.weather_jq div.weather_select_city ul,.weather_jq div.weather_select_jq ul').perfectScrollbar();
